...
3. **Provider-side mechanics** — how pros are matched to and paid for subscription bookings, whether they know a booking is subscription-driven, and which pros participate. Only the subsidy/full-payout concern is raised. Matters for supply cost and provider experience. Ask Jeff / the bookings team.
